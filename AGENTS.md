...
> **Status: M0–M17 shipped.** The original P0 matrix in §2 is
...
example coverage) for a total of 360 active.
...
| Tests | `tests/m{0..18}/` |
| Verification command | `pytest tests/` (360 pass, 19 skipped) |
