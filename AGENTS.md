...
> **Status: M0–M11 shipped.** The original P0 matrix in §2 is
...
243 tests pass; 19 intentionally skipped (clean-room install +
M1+ invariants that need M1+ features).
...
| Tests | `tests/m{0..12}/` |
| Verification command | `pytest tests/` (243 pass, 19 skipped) |
